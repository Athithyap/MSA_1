...
class StockData(forms.ModelForm):
    ...
    expiry_date = forms.DateField(widget=forms.DateInput(attrs={'class':'form-control', 'required':'true'}), label='Expiry Date', required=True)
...
class SalesData(forms.ModelForm):
    ...
    date = forms.DateField(label='date',widget=forms.TextInput(attrs=
                                {
                                    'class':'datepicker'
                                }), required=True)
